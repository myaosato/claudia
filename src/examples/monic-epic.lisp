...
(def-theorem epic->surjective
  ...
  (cut (formulas (→ (∧ (== (f x0) ((partial-id f) y)) (== ((partial-id f) y) y)) (== (f x0) y))))
  (app-a transitivity)
  (to-l)
  (id 1)
  (and-r)
  (id 1)
  (cut (formulas (→ (== ((partial-id f) y) (f x0)) (== (f x0) ((partial-id f) y)))))
  (app-a symmetry)
  (to-l)
  (id)
  (id))
